...
class main_packet_sniffer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "6TiSCH Packet Sniffer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "main_packet_sniffer")
        ...
        self.samp_per_sym = samp_per_sym = samp_rate/bitrate
        self.gain = gain = 0
        ...
        self.limesdr_source_0.set_oversampling(4)

        self.limesdr_source_0.set_center_freq(863.1e6, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_samp_per_sym(self.samp_rate/self.bitrate)
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 50e3, 20e3, firdes.WIN_BLACKMAN, 6.76))
